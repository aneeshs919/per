...
`;const HomePage = () => {
  return (
    <>
      <BoxAlign className="w-full max-w-[800px] mx-auto flex flex-col md:flex-row items-center md:items-start justify-between">
      ...
      <div>
        ...
        <div className="mt-4 flex">
          <a
            ...
            className="bg-[white] text-[#222] rounded-md border border-[#eee] p-2 px-4 flex-grow-0"
          >
            Download CV
          </a>
        </div>
